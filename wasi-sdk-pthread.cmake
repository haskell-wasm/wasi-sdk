...
set(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} -pthread -mcpu=lime1 -mreference-types -msimd128 -mtail-call")
set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -pthread -fno-exceptions -mcpu=lime1 -mreference-types -msimd128 -mtail-call")
